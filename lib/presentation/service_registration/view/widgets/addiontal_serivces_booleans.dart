...
class AdditionalServicesBooleans extends StatefulWidget {
  final AdditionalServicesModel additionalServicesModel;

  const AdditionalServicesBooleans(
      {Key? key, required this.additionalServicesModel})
      : super(key: key);

  @override
  _AdditionalServicesBooleansState createState() =>
      _AdditionalServicesBooleansState();
}

class _AdditionalServicesBooleansState
    extends State<AdditionalServicesBooleans> {
  @override
