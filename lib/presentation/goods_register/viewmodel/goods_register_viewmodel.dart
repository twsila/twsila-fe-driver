...
class GoodsRegisterViewModel extends BaseViewModel
    with GoodsRegisterViewModelInput, GoodsRegisterViewModelOutput {
  ...
  final GoodsRegisterUseCase _registerUseCase;
  ...
  GoodsRegisterViewModel(this._registerUseCase);
  ...
  register() async {
    ...
    (await _registerUseCase.execute(GoodsRegisterUseCaseInput(
  ...
  Stream<bool> get outputServiceType => serviceTypeStreamController.stream
      .map((serviceType) => serviceType == AppStrings.goodsTransportations.tr() ? true : false);
...
abstract class GoodsRegisterViewModelInput {
...
abstract class GoodsRegisterViewModelOutput {
